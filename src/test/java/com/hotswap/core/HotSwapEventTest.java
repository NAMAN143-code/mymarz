...
class HotSwapEventTest {
    ...
    void sensitiveEvent_masksValuesInToString() {
        HotSwapEvent event = new HotSwapEvent(this, "secrets.api-key",
    ...
    void sensitiveEvent_stillExposesRawValuesViaGetters() {
        ...
        HotSwapEvent event = new HotSwapEvent(this, "secrets.key",
    ...
    void nonSensitiveEvent_showsValuesInToString() {
        HotSwapEvent event = new HotSwapEvent(this, "feature.flag",
