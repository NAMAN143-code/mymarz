...
public class ConfigSourceResolver {
     ...
     * If the URI is {@code platform://hotswap} and a defaultSource is configured,
    ...
    private ConfigSource createSource(String uri) {
        ...
        return switch (scheme) {
            ...
            case "platform" -> {
                log.warn("Platform source '{}' not available — set hotswap.default-source or connect to HotSwap Platform.", uri);
                yield null;
            }
