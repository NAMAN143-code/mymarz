...
public class SourceStrategyResolver {
    ...
    public enum Strategy {
        ...
        WATCHSERVICE,
        /** Mode B: WebSocket push from HotSwap Platform, file is bootstrap-only. */
        PLATFORM_PRIMARY,
     ...
     * @param platformAvailable whether the HotSwap Platform agent is connected
    ...
    public Strategy resolveFileStrategy(Path filePath, boolean platformAvailable) {
        ...
        log.warn("WatchService probe FAILED for {}, no platform connection. "
                ...
                + "Connect to HotSwap Platform for instant push propagation.", filePath);
    ...
    boolean probeWatchService(Path filePath) {
        ...
        try {
            ...
            probeFile = Files.createTempFile(dir, ".hotswap-probe-", ".tmp");
