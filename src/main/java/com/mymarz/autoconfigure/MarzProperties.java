 ...
 *
 * <p>All properties are under the {@code marz} prefix in
...
public class MarzProperties {
    ...
    /**
     * Default source URI used when a {@code @Marz} annotation does not
     * specify a source (i.e., source is the default {@code platform://marz}).
     *
