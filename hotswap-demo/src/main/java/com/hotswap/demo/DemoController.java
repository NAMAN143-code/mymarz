...
/**
 * REST endpoints that return current @HotSwap values.
 *
 * Try these while editing config/hotswap-demo.yml:
...
public class DemoController {
    ...
    /**
     * Shows all @HotSwap values at once.
     * Edit config/hotswap-demo.yml and refresh to see changes.
     */
    @GetMapping("/config")
